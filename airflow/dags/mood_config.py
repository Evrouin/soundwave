# Universal mood labels — rule-based classification using audio features.
# Each mood has conditions (feature ranges) and a priority order.
# First matching mood wins. Designed so distribution is balanced.
UNIVERSAL_MOODS = {
...
def classify_universal_mood(energy, valence, danceability, acousticness,
    ...
    # Base scores from audio features
    scores = {
        "Aggressive":  0,
        "Euphoric":    0,
        "Energetic":   0,
    ...
    # Aggressive: high energy + low valence
